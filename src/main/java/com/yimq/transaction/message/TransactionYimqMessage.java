package com.yimq.transaction.message;

import com.alibaba.fastjson.JSONObject;
import com.yimq.transaction.client.YIMQClient;
import com.yimq.transaction.constants.MessageServerTypeConstants;
import com.yimq.transaction.constants.MessageStatusConstants;
import com.yimq.transaction.constants.MessageTypeConstants;
import com.yimq.transaction.dao.MessageDao;
import com.yimq.transaction.dao.SubTaskDao;
import com.yimq.transaction.entity.YimqMessage;
import com.yimq.transaction.entity.MessageEntity;
import com.yimq.transaction.subTask.TccSubTask;
import com.yimq.transaction.utils.FrameDateUtils;
import com.yimq.transaction.subTask.EcSubTask;
...
public class TransactionYimqMessage extends YimqMessage {
    ...
    private void createLocalTransactionRecord(JSONObject messageInfo) {
        ...
        messageEntity.setCreatedAt(FrameDateUtils.currentFormatDate());
        messageEntity.setUpdatedAt(FrameDateUtils.currentFormatDate());
